        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    LinkedObjectType = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    LinkedObjectId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AllowMemberDelete = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_TenantId_Currency",
                table: "Accounts",
                columns: new[] { "TenantId", "Currency" });

            migrationBuilder.CreateIndex(
                name: "IX_Accounts_TenantId_EntityId",
                table: "Accounts",
                columns: new[] { "TenantId", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Attachments_TenantId_LinkedObjectType_LinkedObjectId",
                table: "Attachments",
                columns: new[] { "TenantId", "LinkedObjectType", "LinkedObjectId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Entities_TenantId_GroupId",
                table: "Entities",
                columns: new[] { "TenantId", "GroupId" });

            migrationBuilder.CreateIndex(
                name: "IX_FxRates_TenantId_Date_BaseCurrency_QuoteCurrency",
                table: "FxRates",
                columns: new[] { "TenantId", "Date", "BaseCurrency", "QuoteCurrency" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TenantId_CreatedAtUtc",
                table: "Transactions",
                columns: new[] { "TenantId", "CreatedAtUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TenantId_EntityId",
                table: "Transactions",
                columns: new[] { "TenantId", "EntityId" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TenantId_OriginalCurrency",
                table: "Transactions",
                columns: new[] { "TenantId", "OriginalCurrency" });

            migrationBuilder.CreateIndex(
                name: "IX_Transactions_TenantId_Type",
                table: "Transactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserRoles_TenantId_ScopeType_ScopeId",
                table: "UserRoles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_TenantId_JwtId",
                table: "UserSessions",
